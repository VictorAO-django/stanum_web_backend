...
class AccountRating(models.Model):
    mt5_user = models.OneToOneField(MT5User, on_delete=models.CASCADE, related_name="rating")
    score = models.DecimalField(max_digits=5, decimal_places=2, default=0)  # 0–100
    stars = models.IntegerField(default=0)
    profit_factor = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
